...
window.fbControls.push(function(controlClass, allControlClasses) {
  ...
  class controlTrumbowyg extends controlTextarea {
    ...
    onRender(evt) {
      ...
      let editor = window.fbEditors.trumbowyg[this.id] = $(this.field);
