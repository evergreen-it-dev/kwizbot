jQuery(function($) {
  ...
  var formData='[{ "label": "Выберите, чем я могу вам помочь", "name": "whatcanido",  "type": "radio-group", "values": [{ "action": "section calc",  "configJson": {  "test": 1  },  "label": "Заказать ОСАГО", "value": "order_osago" }]}]';
  var editing = true;
...
//  }
  ...
  setFormData='[{ "label": "Выберите, чем я могу вам помочь", "name": "whatcanido",  "type": "radio-group", "values": [{ "action": "section calc",  "configJson": {  "test": 1  },  "label": "Заказать ОСАГО", "value": "order_osago" }]}]';
